...
const MovieCard = () => {
  return (
    <div className="flex space-y-2 flex-col">
      <Image
        className="w-[150px] h-[230px] md:w-[250px] md:h-[370px]"
        src="/images/stranger-things.png"
        alt="Movie poster"
        width={250}
        height={370}
      />
      <span className="text-muted-foreground max-md:text-xs">USA, 2018 - current</span>
      <h4 className="text-xl font-bold">Stranger Things</h4>
